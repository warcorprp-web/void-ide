...
// Apply icon to main Code.exe
gulp.task(task.define('vscode-win32-x64-code-icon', updateIcon(path.join(buildPath('x64'), `${product.nameShort}.exe`))));
gulp.task(task.define('vscode-win32-arm64-code-icon', updateIcon(path.join(buildPath('arm64'), `${product.nameShort}.exe`))));
