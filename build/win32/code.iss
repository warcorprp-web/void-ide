...
AppPublisher=CryptoCat's lab
AppPublisherURL=https://cryptocatslab.ru/
AppSupportURL=https://code.visualstudio.com/
AppUpdatesURL=https://code.visualstudio.com/
DefaultGroupName={#NameLong}
AllowNoIcons=yes
OutputDir={#OutputDir}
OutputBaseFilename=IskraIDESetup
Compression=lzma
...
; WizardImageFile="{#RepoDir}\\resources\\win32\\inno-iskra-big.bmp"
WizardSmallImageFile="{#RepoDir}\\resources\\win32\\inno-iskra-small.bmp"
